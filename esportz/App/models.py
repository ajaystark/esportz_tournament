...
class FreeFire(models.Model):
    ...
    player1_photo = models.ImageField(upload_to='images', blank=True)
    ...
    player2_photo = models.ImageField(upload_to='images', blank=True)
    ...
    player3_photo = models.ImageField(upload_to='images', blank=True)
    ...
    player4_photo = models.ImageField(upload_to='images', blank=True)
    ...
    player5_photo = models.ImageField(upload_to='images', blank=True)
    ...
    player6_photo = models.ImageField(upload_to='images', blank=True)
